...
load("/udd/reish/Microbiome/DATA/phyloseq_M3_tax.rda") # 3-6 months
load("/udd/reish/Microbiome/DATA/phyloseq_Y1_tax.rda") # 1 year
load("/udd/reish/Microbiome/DATA/phyloseq_Y3_tax.rda") # 3 year
load("/udd/reish/Microbiome/DATA/phyloseq_Y4_tax_genus.rda") # 4 year
load("/udd/reish/Microbiome/DATA/phyloseq_Y5_tax.rda") # 5 year
load("/udd/reish/Microbiome/DATA/FinalV2_g_all.rda") # all years together
...
#### Meta data ####
# load metadata 
db <- read.csv("/proj/stvtds/stvtd00/FINAL_datasets/jama2016tab2.csv")
vdaartbirth <- read.csv("/proj/stvtds/stvtd00/FINAL_datasets/vdaartbirth.csv")
PE_metadata <- read.csv("/proj/stvtds/stvtd00/FINAL_datasets/peanalysis.csv", stringsAsFactors=FALSE, header=TRUE) #n=816
enroll <- read.csv("/proj/stvtds/stvtd00/FINAL_datasets/EnrollMaternal.csv")
load("/udd/reish/Microbiome/DATA/OG806vids.rda") # vID's used in total VDAART #806
...
stooldate <- read.csv("/udd/reish/Microbiome/DATA/ttrimdietm6ffsamp.csv")
x<-c("vid","childm3ffdate")
stooldate<-subset(stooldate, select=x)

# Merge in delivery date
epi1 <- read.csv("/proj/stvtds/stvtd00/FINAL_datasets/babyracen819.csv")
...
meta$childm3ffdate[meta$vid == "319874"] <- "06/21/2011"
meta$childm3ffdate[meta$vid == "326992"] <- "06/17/2011"
meta$childm3ffdate[meta$vid == "347595"] <- "02/29/2012"
meta$childm3ffdate[meta$vid == "357032"] <- "06/15/2011"
meta$childm3ffdate[meta$vid == "371573"] <- "04/13/2011"
meta$childm3ffdate[meta$vid == "380436"] <- "10/30/2011"
meta$childm3ffdate[meta$vid == "382772"] <- "09/13/2011"
...
# save datasets 
#getwd()
#setwd("/udd/reish/Microbiome/DATA")
...
# save dataset
#setwd("/udd/reish/Microbiome/DATA")
#save(dfall, file="/udd/reish/Microbiome/DATA/FinalV2_g_all.rda")

# SECTION 2. VDAART dataset PHYLOSEQ  ----------------------------------------------------------

#### Microbial data ####
#load phyloseq objects 
data <- readRDS("/udd/reish/Microbiome/DATA/data_g.rds") # genus collapsed phyloseq from /udd/rekle/QIIME2_Pipeline
...
#saveRDS(df, "/udd/reish/Microbiome/DATA/phylo_finalV2.rds")
...
mydf <- read.table("/udd/reish/Microbiome/DATA/significant_results.tsv"
                   , sep = '\t', header = TRUE)
...
# Supplemental Table S1. Comparisons of VDAART pregnant women’s characteristics and those of their infants included and not included in this study.
